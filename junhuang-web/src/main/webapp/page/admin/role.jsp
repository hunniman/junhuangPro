...
// 		            alert('You click like action, row: ' + JSON.stringify(row));
                    $("#page_content").load(projectPath+"/back/roleAdd?id="+row.id);
                    ...
                    Modal.confirm(
                            {
                                ...
                                $.ajax({
                                    type: "get",
                                    dataType: "json",
                                    url: projectPath+"/back/deleteRole",
                                    data: {id:row.id},
...
<body>
   ...
   <div class="rows" style="float:right;">
       <button id="btnRAdd" class="btn btn-primary ladda-button" data-style="expand-right" type="button">
           <span class="ladda-label">添加角色</span>
       </button>
   </div>
